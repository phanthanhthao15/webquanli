                ...
                <div class="box-menu">
                    <div class="menu-wrapper">
                        <ul>
                            ...
                            <li id="installment"><a href="installment.php">Quần áo màu hè</a></li>
                            <li id="newcar"><a href="newsinformation.php">Quần áo mùa đông</a></li>
                            <li><a href="newcarprice.php">Giày dép</a></li>
                            <li id="news"><a href="news.php">Đánh giá</a></li>
                            <li id="contact"><a href="contact.php">đánh giá</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <div class="footer1">
                <div class="footer1-left">
                    ...
                    <h3>
                        <b>Xí Nghiệp Toyota Hoàn Kiếm Hà Nội</b> là doanh nghiệp nhà nước trực thuộc Tổng Công ty Vận tải Hà Nội được thành lập ngày 10/5/1997.<br>
                        Địa chỉ: Số 7 phố Đặng Thái Thân, phường Phan Chu Trinh, quận Hoàn Kiếm, thành phố Hà Nội
                    </h3>
                    <p>Hotline Trương Văn An: 0988937058</p>
                </div>
